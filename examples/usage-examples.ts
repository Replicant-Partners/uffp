...
async function spaceExample() {
  ...
  console.log(`  P10 (Bear Case):  $${toMillions(result.p10).toFixed(2)}M`);
  console.log(`  P50 (Base Case):  $${toMillions(result.p50).toFixed(2)}M`);
  console.log(`  P90 (Bull Case):  $${toMillions(result.p90).toFixed(2)}M`);
  console.log(`  Mean:             $${toMillions(result.mean).toFixed(2)}M`);
  console.log(`  Std Dev:          $${toMillions(result.stdDev).toFixed(2)}M\n`);
